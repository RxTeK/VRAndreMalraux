...
class OCULUSINTERACTION_API UIsdkGrabberComponent : public UIsdkSceneInteractorComponent
{
 ...
 protected:
   ...
   * @param InputMethod
   */
  void SelectByInputMethod(EIsdkGrabInputMethod InputMethod);

  /**
   * Attempt to unselect any grabbables for the given input method
   * @param InputMethod
   */
  void UnselectByInputMethod(EIsdkGrabInputMethod InputMethod);
  ...
  // Whether or not this Grabber will detect grabbables using hand colliders
  UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = InteractionSDK)
  bool bAllowHandGrab = true;

  // Whether or not this grabber will detect grabbables by ray
  UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = InteractionSDK)
  bool bAllowRayGrab = true;

  // Whether or not this grabber will detect grabbables with a cone
  UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = InteractionSDK)
  bool bAllowDistanceGrab = true;
 ...
 private:
  ...
  EIsdkGrabInputMethod CurrentGrabInputMethod;
