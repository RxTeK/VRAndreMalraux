...
void UIsdkHandVisualsRigComponent::SetSubobjectPropertyDefaults(EIsdkHandedness InHandedness)
{
  ...
  else if (InHandedness == EIsdkHandedness::Right)
  {
    ...
    UMaterial* DefaultHandMaterial)
{
  ...
  if (ensureMsgf(
          ...
          *HandMesh->GetOwner()->GetFullName()))
  {
    HandMesh->SetSkinnedAsset(DefaultHandMesh);
  }
  ...
  if (ensureMsgf(
          ...
          *HandMesh->GetOwner()->GetFullName()))
  {
    HandMesh->SetMaterial(0, DefaultHandMaterial);
  }
}
