...
#define FID_GithubProject_VRAndreMalraux_Plugins_MetaXR_Source_MRUtilityKit_Public_MRUtilityKitSubsystem_h_43_DELEGATE \
static void FOnLoaded_DelegateWrapper(const FMulticastScriptDelegate& OnLoaded, bool Success);


#define FID_GithubProject_VRAndreMalraux_Plugins_MetaXR_Source_MRUtilityKit_Public_MRUtilityKitSubsystem_h_44_DELEGATE \
static void FOnCaptureComplete_DelegateWrapper(const FMulticastScriptDelegate& OnCaptureComplete, bool Success);


#define FID_GithubProject_VRAndreMalraux_Plugins_MetaXR_Source_MRUtilityKit_Public_MRUtilityKitSubsystem_h_45_DELEGATE \
static void FOnRoomCreated_DelegateWrapper(const FMulticastScriptDelegate& OnRoomCreated, AMRUKRoom* Room);


#define FID_GithubProject_VRAndreMalraux_Plugins_MetaXR_Source_MRUtilityKit_Public_MRUtilityKitSubsystem_h_46_DELEGATE \
static void FOnRoomUpdated_DelegateWrapper(const FMulticastScriptDelegate& OnRoomUpdated, AMRUKRoom* Room);


#define FID_GithubProject_VRAndreMalraux_Plugins_MetaXR_Source_MRUtilityKit_Public_MRUtilityKitSubsystem_h_47_DELEGATE \
static void FOnRoomRemoved_DelegateWrapper(const FMulticastScriptDelegate& OnRoomRemoved, AMRUKRoom* Room);


#define FID_GithubProject_VRAndreMalraux_Plugins_MetaXR_Source_MRUtilityKit_Public_MRUtilityKitSubsystem_h_40_RPC_WRAPPERS_NO_PURE_DECLS \
...
#define FID_GithubProject_VRAndreMalraux_Plugins_MetaXR_Source_MRUtilityKit_Public_MRUtilityKitSubsystem_h_40_INCLASS_NO_PURE_DECLS \
private: \
...
#define FID_GithubProject_VRAndreMalraux_Plugins_MetaXR_Source_MRUtilityKit_Public_MRUtilityKitSubsystem_h_40_ENHANCED_CONSTRUCTORS \
...
#define FID_GithubProject_VRAndreMalraux_Plugins_MetaXR_Source_MRUtilityKit_Public_MRUtilityKitSubsystem_h_37_PROLOG
#define FID_GithubProject_VRAndreMalraux_Plugins_MetaXR_Source_MRUtilityKit_Public_MRUtilityKitSubsystem_h_40_GENERATED_BODY \
PRAGMA_DISABLE_DEPRECATION_WARNINGS \
public: \
	FID_GithubProject_VRAndreMalraux_Plugins_MetaXR_Source_MRUtilityKit_Public_MRUtilityKitSubsystem_h_40_RPC_WRAPPERS_NO_PURE_DECLS \
	FID_GithubProject_VRAndreMalraux_Plugins_MetaXR_Source_MRUtilityKit_Public_MRUtilityKitSubsystem_h_40_INCLASS_NO_PURE_DECLS \
	FID_GithubProject_VRAndreMalraux_Plugins_MetaXR_Source_MRUtilityKit_Public_MRUtilityKitSubsystem_h_40_ENHANCED_CONSTRUCTORS \
private: \
...
#define CURRENT_FILE_ID FID_GithubProject_VRAndreMalraux_Plugins_MetaXR_Source_MRUtilityKit_Public_MRUtilityKitSubsystem_h
