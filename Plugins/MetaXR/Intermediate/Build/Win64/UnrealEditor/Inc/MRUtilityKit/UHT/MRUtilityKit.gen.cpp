...
// Begin Registration
struct Z_CompiledInDeferFile_FID_GithubProject_VRAndreMalraux_Plugins_MetaXR_Source_MRUtilityKit_Public_MRUtilityKit_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		...
		{ EMRUKComponentType_StaticEnum, TEXT("EMRUKComponentType"), &Z_Registration_Info_UEnum_EMRUKComponentType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 4038460873U) },
		{ EMRUKFallbackToProceduralOverwrite_StaticEnum, TEXT("EMRUKFallbackToProceduralOverwrite"), &Z_Registration_Info_UEnum_EMRUKFallbackToProceduralOverwrite, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2618105123U) },
		{ EMRUKSpawnMode_StaticEnum, TEXT("EMRUKSpawnMode"), &Z_Registration_Info_UEnum_EMRUKSpawnMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3644066624U) },
	};
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FMRUKHit::StaticStruct, Z_Construct_UScriptStruct_FMRUKHit_Statics::NewStructOps, TEXT("MRUKHit"), &Z_Registration_Info_UScriptStruct_MRUKHit, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMRUKHit), 3844638834U) },
		{ FMRUKLabelFilter::StaticStruct, Z_Construct_UScriptStruct_FMRUKLabelFilter_Statics::NewStructOps, TEXT("MRUKLabelFilter"), &Z_Registration_Info_UScriptStruct_MRUKLabelFilter, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMRUKLabelFilter), 3515847644U) },
		{ FMRUKPlaneUV::StaticStruct, Z_Construct_UScriptStruct_FMRUKPlaneUV_Statics::NewStructOps, TEXT("MRUKPlaneUV"), &Z_Registration_Info_UScriptStruct_MRUKPlaneUV, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMRUKPlaneUV), 3856177138U) },
		{ FMRUKTexCoordModes::StaticStruct, Z_Construct_UScriptStruct_FMRUKTexCoordModes_Statics::NewStructOps, TEXT("MRUKTexCoordModes"), &Z_Registration_Info_UScriptStruct_MRUKTexCoordModes, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMRUKTexCoordModes), 1141421201U) },
		{ FMRUKSpawnActor::StaticStruct, Z_Construct_UScriptStruct_FMRUKSpawnActor_Statics::NewStructOps, TEXT("MRUKSpawnActor"), &Z_Registration_Info_UScriptStruct_MRUKSpawnActor, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMRUKSpawnActor), 3393791338U) },
		{ FMRUKSpawnGroup::StaticStruct, Z_Construct_UScriptStruct_FMRUKSpawnGroup_Statics::NewStructOps, TEXT("MRUKSpawnGroup"), &Z_Registration_Info_UScriptStruct_MRUKSpawnGroup, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMRUKSpawnGroup), 3342967623U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UMRUKSettings, UMRUKSettings::StaticClass, TEXT("UMRUKSettings"), &Z_Registration_Info_UClass_UMRUKSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMRUKSettings), 1665583228U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_GithubProject_VRAndreMalraux_Plugins_MetaXR_Source_MRUtilityKit_Public_MRUtilityKit_h_1589227704(TEXT("/Script/MRUtilityKit"),
	Z_CompiledInDeferFile_FID_GithubProject_VRAndreMalraux_Plugins_MetaXR_Source_MRUtilityKit_Public_MRUtilityKit_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_GithubProject_VRAndreMalraux_Plugins_MetaXR_Source_MRUtilityKit_Public_MRUtilityKit_h_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_GithubProject_VRAndreMalraux_Plugins_MetaXR_Source_MRUtilityKit_Public_MRUtilityKit_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_GithubProject_VRAndreMalraux_Plugins_MetaXR_Source_MRUtilityKit_Public_MRUtilityKit_h_Statics::ScriptStructInfo),
	Z_CompiledInDeferFile_FID_GithubProject_VRAndreMalraux_Plugins_MetaXR_Source_MRUtilityKit_Public_MRUtilityKit_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_GithubProject_VRAndreMalraux_Plugins_MetaXR_Source_MRUtilityKit_Public_MRUtilityKit_h_Statics::EnumInfo));
// End Registration
